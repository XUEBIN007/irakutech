(function (root) {
  ...
  const dict = {
    ja: {
      brand: '本町中華 QR注文', store_address: '船橋市本町エリア', cash_notice: '公開情報では現金中心。カード・QR決済は店頭確認後に有効化します。', course_note: '食べ飲み放題は4名様から・ラストオーダー15分前です。',
      ...
      seat_start_title: 'ご来店ありがとうございます', seat_start_desc: '人数を入力してから注文を開始してください。店内スタッフ側にもこのテーブルが利用中として表示されます。', seat_start_action: '注文を開始', seat_started: 'テーブル {table}・{count}名で開始しました', seat_required: '先に人数を入力してください',
      ...
      order_progress: '料理進捗', order_progress_done: '{done}/{total}品 完成', order_progress_status: '新規{fresh} / 調理中{preparing} / 完成{done}', order_progress_ready: 'すべて完成しました',
      ...
      status_new: '新規', status_preparing: '調理中', status_done: '完成', status_paid: '会計済', status_canceled: 'キャンセル', status_available: '空席', status_occupied: '利用中', status_checkout_requested: '会計依頼中', action_preparing: '調理中', action_done: '完成', action_cancel: '取消', set_preparing: '調理中にしました', set_done: '完成にしました', set_canceled: '取消しました',
      ...
      course_filter_title: '放題メニュー', course_filter_action: '放題対象のみ', course_filter_desc: '食べ飲み放題中は対象メニューだけに絞り込めます。', course_excluded: '放題対象外',
      table_due: '未会計', table_badge_call: '呼出', table_badge_checkout: '会計依頼', table_badge_course_last_order: 'L.O.間近', table_badge_course_ended: '放題終了', table_badge_disabled: '停止',
      ...
      ,qr_links: 'QRリンク一覧', sales_summary: '売上サマリー', paid_total: '会計済', unpaid_total: '未会計', canceled_count: '取消数', copy_url: 'URLコピー'
    ...
    zh: {
      brand: '本町中华扫码点餐', store_address: '船桥市本町区域', cash_notice: '公开信息显示以现金为主。信用卡和 QR 支付需到店确认后再启用。', course_note: '吃喝放题 4 位起，最后点单为结束前 15 分钟。',
      ...
      seat_start_title: '欢迎光临', seat_start_desc: '请先输入人数并开始用餐。店员端会同步显示这张桌已经入座。', seat_start_action: '开始点菜', seat_started: '{table} 号桌・{count} 位已开始', seat_required: '请先输入人数',
      ...
      order_progress: '出餐进度', order_progress_done: '已完成 {done}/{total} 件', order_progress_status: '新订单{fresh} / 制作中{preparing} / 已完成{done}', order_progress_ready: '菜品已全部完成',
      ...
      status_new: '新订单', status_preparing: '制作中', status_done: '已完成', status_paid: '已结账', status_canceled: '已取消', status_available: '空桌', status_occupied: '用餐中', status_checkout_requested: '请求结账', action_preparing: '制作中', action_done: '完成', action_cancel: '取消', set_preparing: '已设为制作中', set_done: '已设为完成', set_canceled: '已取消',
      ...
      course_filter_title: '放题菜单', course_filter_action: '只看放题对象', course_filter_desc: '放题期间可只显示可追加菜单。', course_excluded: '放题对象外',
      table_due: '未结账', table_badge_call: '呼叫', table_badge_checkout: '请求结账', table_badge_course_last_order: '最后点单', table_badge_course_ended: '放题结束', table_badge_disabled: '停用',
      ...
      ,qr_links: '二维码链接列表', sales_summary: '销售摘要', paid_total: '已结账', unpaid_total: '未结账', canceled_count: '取消数', copy_url: '复制链接'
    ...
    en: {
      brand: 'Honcho Chinese QR Order', store_address: 'Honcho area, Funabashi', cash_notice: 'Public information suggests cash-first checkout. Card and QR payments can be enabled after store confirmation.', course_note: 'All-you-can-eat/drink starts from four guests. Last order is 15 minutes before the end.',
      ...
      seat_start_title: 'Welcome', seat_start_desc: 'Enter the guest count before ordering. Staff will see this table as occupied.', seat_start_action: 'Start Ordering', seat_started: 'Table {table} started for {count} guests', seat_required: 'Enter guest count first',
      ...
      order_progress: 'Kitchen Progress', order_progress_done: '{done}/{total} items done', order_progress_status: 'New {fresh} / Preparing {preparing} / Done {done}', order_progress_ready: 'All items are ready',
      ...
      status_new: 'New', status_preparing: 'Preparing', status_done: 'Done', status_paid: 'Paid', status_canceled: 'Canceled', status_available: 'Open', status_occupied: 'Occupied', status_checkout_requested: 'Checkout Requested', action_preparing: 'Preparing', action_done: 'Done', action_cancel: 'Cancel', set_preparing: 'Marked as preparing', set_done: 'Marked as done', set_canceled: 'Canceled',
      ...
      course_filter_title: 'Course Menu', course_filter_action: 'Course items only', course_filter_desc: 'During a course, filter to included add-on items.', course_excluded: 'Not included',
      table_due: 'Due', table_badge_call: 'Call', table_badge_checkout: 'Checkout', table_badge_course_last_order: 'Last order', table_badge_course_ended: 'Course ended', table_badge_disabled: 'Disabled',
      ...
      ,qr_links: 'QR Links', sales_summary: 'Sales Summary', paid_total: 'Paid', unpaid_total: 'Unpaid', canceled_count: 'Canceled', copy_url: 'Copy URL'
