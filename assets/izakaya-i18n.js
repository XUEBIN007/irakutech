(function (root) {
  ...
  const dict = {
    ja: {
      ...
      order_progress: '料理進捗', order_progress_done: '{done}/{total}品 完成', order_progress_ready: 'すべて完成しました',
    ...
    zh: {
      ...
      order_progress: '出餐进度', order_progress_done: '已完成 {done}/{total} 件', order_progress_ready: '菜品已全部完成',
    ...
    en: {
      ...
      order_progress: 'Kitchen Progress', order_progress_done: '{done}/{total} items done', order_progress_ready: 'All items are ready',
