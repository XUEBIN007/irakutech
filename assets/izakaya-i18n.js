(function (root) {
  ...
  const dict = {
    ja: {
      ...
      kitchen_new: '新規注文', kitchen_preparing: '調理中', kitchen_done: '完成', kitchen_empty_new: '新しい注文はありません。', kitchen_empty_preparing: '調理中の注文はありません。', kitchen_empty_done: '完成済みの注文はありません。', item_count: '{count}品', waiting_checkout: '会計待ち',
    ...
    zh: {
      ...
      takeout_eyebrow: '店外点单', takeout_title: '外卖・到店自取', takeout_desc: '顾客可以在家或公司下单，选择到店自取或店铺配送。', fulfillment_method: '取餐方式', customer_name: '姓名', customer_phone: '电话', delivery_address: '配送地址', fulfillment_note: '备注事项', subtotal: '小计', delivery_fee: '配送费', takeout_submit: '提交订单', takeout_notice: '店铺确认后，会开始准备自取或配送。', takeout_missing: '请填写姓名、电话和希望时间。',
      kitchen_eyebrow: '厨房接单', kitchen_title: '厨房订单', kitchen_desc: '把新订单推进到制作中或已完成。', kitchen_to_checkout: '去结账 →', kitchen_empty: '暂无待处理订单。',
      kitchen_new: '新订单', kitchen_preparing: '制作中', kitchen_done: '已完成', kitchen_empty_new: '暂无新订单。', kitchen_empty_preparing: '暂无制作中订单。', kitchen_empty_done: '暂无已完成订单。', item_count: '{count}件', waiting_checkout: '等待结账',
    ...
    en: {
      ...
      kitchen_new: 'New', kitchen_preparing: 'Preparing', kitchen_done: 'Done', kitchen_empty_new: 'No new orders.', kitchen_empty_preparing: 'No preparing orders.', kitchen_empty_done: 'No completed orders.', item_count: '{count} items', waiting_checkout: 'Waiting for checkout',
